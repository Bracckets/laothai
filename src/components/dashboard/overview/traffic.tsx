...
const iconMapping = { قناع: FaceMaskIcon, خوذة: HardHatIcon, سترة: ShirtFoldedIcon } as Record<string, Icon>;
...
export function Traffic({ chartSeries, labels, sx }: TrafficProps): React.JSX.Element {
  ...
  return (
    <Card sx={sx}>
      <CardHeader title="مصدر المخالفات" subheaderTypographyProps={"Font-size = 12px"} subheader="اسبوعيًا" />
      <CardContent>
        <Stack spacing={2}>
